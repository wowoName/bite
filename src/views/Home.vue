    ...
    <div class='home'>
        <div class="home-left">
            ...
            <div class="home-left-tabs">
                <div v-for="(item,index) in parkingLotData" :class="{activeTab:activeParkingLotType===index}" :key="index" class="tabs" @click="changeParkingLot(index)">{{item}}</div>
            ...
            <div class="right-top">
                <div class="right-top-item wisdom-right-height right-top-item-bg">
                    ...
                    <div class="right ">
                        ...
                        <div class="wisdom-right-line-left"></div>
...
export default {
    components: { PieCharts, ChartsTitle, AnimatedNumber, LineCharts, BarCharts, TransBarCharts, MapCharts, WisdomTitle },
    data() {

        return {
            vehicles: 1548,//车辆数量
            berth: 5848,//泊位数量
            parkingLotData: ['全部停车场', '门前三包区域停车场', '公共停车场', '社会停车场', '景区停车场', '收费停车场', '停车场诱导', '免费停车场'],
                    ...
                    .left-top {
                        ...
                        .left-top-left {
                            ...
                            .pieCharts-item {
                                ...
                                height: 50%;
                                width: 100%;
                                background: url(../assets/img/pieCharts.png)
                                    no-repeat center center / 85% auto;
                                position: relative;
                            }
                        }
                        .wisdom-4px {
